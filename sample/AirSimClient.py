...
class AirSimClientBase:
    ...
    def simSetObjectPose(self, object_name, object_pose):
        self.client.call('simSetObjectPose', object_name, object_pose)
    ...
    def setCameraAngle(self, camera_id, roll, pitch, yaw):
        self.client.call('setCameraAngle', camera_id, roll, pitch, yaw)

    def rotateCameraBySpeed(self, camera_id,  v_roll, v_pitch, v_yaw, duration):
        self.client.call('rotateCameraBySpeed', camera_id, v_roll, v_pitch, v_yaw, duration)
